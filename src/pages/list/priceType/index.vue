  ...
  <div class="pa-2">
    ...
    <v-card>
      <v-dialog persistent class="mt-2 pa-2" v-model="dialog"
                @keyup.esc="isExistsPriceType ? checkUpdate() : checkAndClose()">
    ...
    <filter-canvas>
      <div class="d-flex flex-column ga-4 w-100">
        ...
        <custom-filter-autocomplete min-width="106" label="Валюта" v-model="filterForm.currency_id"
                                    :items="currencies"/>
        <custom-filter-text-field min-width="106" v-model="filterForm.description" label="Описание"/>
        <custom-filter-autocomplete min-width="106" label="Помечен на удаление" v-model="filterForm.deleted"
